  ...
  group('testAsyncNotifier', () {
    ...
    group('CounterStreamNotifier', () {
      ...
      providerTest(
        ...
        expect: () => [const AsyncData(0), const AsyncData(1), const AsyncData(2)],
      );
    ...
    group('AsyncCounterAsyncNotifier', () {
      ...
      providerTest(
        ...
        provider: asyncCounterAsyncNotifierProvider,
        act: (container) => container.read(asyncCounterAsyncNotifierProvider.notifier).increment(),
      ...
      providerTest(
        ...
        act: (container) => container.read(listAsyncNotifierProvider.notifier).getFromRepository(),
      ...
      providerTest(
        ...
        provider: asyncCounterAsyncNotifierProvider,
        act: (container) async {
          await container.read(asyncCounterAsyncNotifierProvider.notifier).increment();
          await Future<void>.delayed(const Duration(milliseconds: 10));
          await container.read(asyncCounterAsyncNotifierProvider.notifier).increment();
        },
    ...
    group('DebounceCounterNotifier', () {
      ...
      providerTest(
        'expect [AsyncData(1)] when increment is called',
        provider: debounceCounterAsyncNotifierProvider,
        act: (container) => container.read(debounceCounterAsyncNotifierProvider.notifier).increment(),
      ...
      providerTest(
        ...
        provider: debounceCounterAsyncNotifierProvider,
        act: (container) async {
          await container.read(debounceCounterAsyncNotifierProvider.notifier).increment();
    ...
    group('MultiCounterAsyncNotifier', () {
      ...
      providerTest(
        ...
        provider: multiCounterAsyncNotifierProvider,
        act: (container) => container.read(multiCounterAsyncNotifierProvider.notifier).increment(),
        expect: () => const <AsyncValue<int>>[AsyncData(1), AsyncData(2)],
      );
      ...
      providerTest(
        ...
        provider: multiCounterAsyncNotifierProvider,
        act: (container) async {
          container.read(multiCounterAsyncNotifierProvider.notifier).increment();
          await Future<void>.delayed(const Duration(milliseconds: 10));
          container.read(multiCounterAsyncNotifierProvider.notifier).increment();
        },
        expect: () => const <AsyncValue<int>>[
    ...
    group('SideEffectAsyncNotifier', () {
      ...
      providerTest(
        ...
        act: (container) => container.read(sideEffectAsyncNotifierProvider(1).notifier).incrementByRepository(),
...
//       });
  ...
  group('tearDown', () {
    ...
    providerTest(
      ...
      verify: (container) => state = container.read(counterAsyncNotifierProvider(0).notifier).state,
      tearDown: () {
        tearDownCallCount++;
    ...
    providerTest(
      ...
      expect: () => contains(const AsyncData(1)),
      // ignore: invalid_use_of_protected_member
      verify: (container) => state = container.read(counterStreamNotifierProvider(0).notifier).state,
      tearDown: () {
        tearDownCallCount++;
        expect(state, equals(const AsyncData(1)));
      },
